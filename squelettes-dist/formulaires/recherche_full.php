...
function formulaires_recherche_full_charger_dist($lien = '', $class=''){
	if ($GLOBALS['spip_lang'] != $GLOBALS['meta']['langue_site'])
		$lang = $GLOBALS['spip_lang'];
	else
		$lang='';

	$action = ($lien ? $lien : generer_url_public('recherche-full')); # action specifique, ne passe pas par Verifier, ni Traiter
	return 
		array(
			'action' => $action,
